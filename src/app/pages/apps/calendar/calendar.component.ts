...
/**
 * Calendar component - handling the email inbox with navbar and content
 */
export class CalendarComponent implements OnInit {
  ...
  ngOnInit() {
    this.breadCrumbItems = [{ label: 'Minton', path: '/' }, { label: 'Apps', path: '/' }, { label: 'Calendar', path: '/', active: true }];
